...
const String kaGssocContriCerti = "$basePath$certificatePath/gssoc.jpg";
const String kaGssocMentorCerti = "$basePath$certificatePath/mentor_gssoc.jpg";
const String kaGenAiCerti = "$basePath$certificatePath/gen_ai.jpg";
const String kaUxCerti = "$basePath$certificatePath/coursera_ux.jpg";
